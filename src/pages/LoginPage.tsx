        ...
        <div className="rounded-2xl border border-border bg-card p-8 shadow-xl">
          <div className="mb-6 flex flex-col items-center text-center">
            <div className="rounded-md bg-white p-3 shadow-sm ring-1 ring-border">
              <img src={logo} alt="Thinking Spree" className="h-14 w-auto" />
            </div>
          ...
          <p className="mt-6 text-center text-[11px] leading-relaxed text-muted-foreground">
            By continuing, you agree that this is an internal workspace and
            your activity may be logged for audit purposes.
          </p>
        </div>
